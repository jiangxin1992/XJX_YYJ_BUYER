...
-(void)updateUI{
    ...
    if([LanguageManager isEnglishLanguage]){
        _orderStatusBtnWidthLayout1.constant = 170;
        _orderStatusBtnWidthLayout2.constant = 170;
    }else{
        _orderStatusBtnWidthLayout1.constant = 108;
        _orderStatusBtnWidthLayout2.constant = 108;
    }
