...
-(void)updateUI{
    ...
    _totalStyleLabel.text = [NSString stringWithFormat:@"%li %@ %li %@",_stylesAndTotalPriceModel.totalStyles,NSLocalizedString(@"款",nil),_stylesAndTotalPriceModel.totalCount,NSLocalizedString(@"件",nil)];
