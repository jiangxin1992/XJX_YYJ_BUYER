...
- (void)viewDidLoad {
    ...
    _orderCodeLabel.text = [NSString stringWithFormat:@"%@%@%@  %@%@%@",NSLocalizedString(@"订单",nil),NSLocalizedString(@"：",nil),_confirmInfoModel.originOrderCode,NSLocalizedString(@"建单",nil),NSLocalizedString(@"：",nil),getShowDateByFormatAndTimeInterval(@"yyyy/MM/dd HH:mm",[_confirmInfoModel.orderCreateTime stringValue])];
    _styleTotalLabel.text = replaceMoneyFlag([NSString stringWithFormat:@"%@%@%@%@%@%@ ￥%@",NSLocalizedString(@"共计",nil),NSLocalizedString(@"：",nil),_confirmInfoModel.styleAmount,NSLocalizedString(@"款",nil),_confirmInfoModel.itemAmount,NSLocalizedString(@"件",nil),_confirmInfoModel.totalPrice],[_confirmInfoModel.curType integerValue]);
