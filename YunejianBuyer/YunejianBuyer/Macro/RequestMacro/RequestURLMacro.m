...
#pragma mark - 库存管理相关
/** 获取入库记录页的选择仓库列表 */
NSString * const kWarehouseList = @"/service/warehouse/queryPutInStorageWarehouse";
/** 获取入库记录 */
NSString * const kWarehouseRecord = @"/service/itemIncoming/getPutInStorageRecord";
/** 获取入库详情 */
NSString * const kWarehouseDetails = @"/service/itemIncoming/getPutInStorageDetail";
