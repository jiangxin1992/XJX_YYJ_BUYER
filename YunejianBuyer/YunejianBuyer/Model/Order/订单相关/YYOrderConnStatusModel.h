...
//相对上面 如果是原单 appendOrderConnStatus 有值 originOrderConnStatus 没值
@property (strong, nonatomic) NSString <Optional>*appendOrderConnStatus;
@property (strong, nonatomic) NSString <Optional>*originOrderConnStatus;
