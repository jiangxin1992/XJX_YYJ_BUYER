...
- (void)initContentView {
    ...
    _contentView.backgroundColor = [UIColor colorWithRed:239 / 255.0 green:239 / 255.0 blue:239 / 255.0 alpha:1.0];
...
- (void)initButtons {
    if (_buttonTitleArray.count > 0) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(0, contentViewHeight + 1, contentViewWidth, 60)];
        ...
        _buttonView.layer.cornerRadius = 0.0;
...
- (void)initCancelButton {
    if (_cancelButtonTitle != nil) {
        _cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(0, contentViewHeight + SPACE_SMALL, contentViewWidth, 59)];
        _cancelButton.backgroundColor = [UIColor whiteColor];
        _cancelButton.titleLabel.font = [UIFont systemFontOfSize:17];
        _cancelButton.layer.cornerRadius = 0.0;
    ...
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, contentViewHeight, contentViewWidth, kBottomSafeAreaHeight)];
    bottomView.backgroundColor = _define_white_color;
    [self.contentView addSubview:bottomView];
    contentViewHeight += kBottomSafeAreaHeight;
}
